...
const AjvModule = moduleRequire('ajv');
const Ajv = (AjvModule.default ?? AjvModule) as typeof import('ajv').default;
const addFormatsModule = moduleRequire('ajv-formats');
const addFormats = (addFormatsModule.default ??
  addFormatsModule) as typeof import('ajv-formats').default;
const OpenAPISchemaValidatorModule = moduleRequire('openapi-schema-validator');
const OpenAPISchemaValidator = (OpenAPISchemaValidatorModule.default ??
  OpenAPISchemaValidatorModule) as typeof import('openapi-schema-validator').default;
...
export class Validator {
  ...
  private strictValidator: InstanceType<typeof OpenAPISchemaValidator>;
