...
### v0.2 Compatibility Note

Because the package is still pre-1.0, v0.2 uses a minor release to make runtime-breaking modernization changes:

- Node 18 and Node 20 support is dropped.
- Node 24+ is required.
- Programmatic usage is ESM-first.
