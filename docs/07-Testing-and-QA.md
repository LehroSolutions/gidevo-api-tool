...
## 1.2 OSS Test Matrix (v0.2.0)

Additional v0.2 coverage includes:

- NodeNext/ESM CLI execution.
- `createProgram()` command registration.
- `doctor --json` project health reports.
- `workflow --dry-run --json` validation without file writes.
- E2E Go generation through `workflow`.
- ESM plugin loading.
